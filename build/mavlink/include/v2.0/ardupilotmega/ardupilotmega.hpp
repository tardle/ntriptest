...
constexpr auto HEADING_TYPE_ENUM_END = 3;
...
/** @brief  */
enum class SECURE_COMMAND_OP : uint32_t
{
    GET_SESSION_KEY=0, /* Get an 8 byte session key which is used for remote secure updates which operate on flight controller data such as bootloader public keys. Return data will be 8 bytes on success. The session key remains valid until either the flight controller reboots or another SECURE_COMMAND_GET_SESSION_KEY is run. | */
    GET_REMOTEID_SESSION_KEY=1, /* Get an 8 byte session key which is used for remote secure updates which operate on RemoteID module data. Return data will be 8 bytes on success. The session key remains valid until either the remote ID module reboots or another SECURE_COMMAND_GET_REMOTEID_SESSION_KEY is run. | */
    REMOVE_PUBLIC_KEYS=2, /* Remove range of public keys from the bootloader. Command data consists of two bytes, first byte if index of first public key to remove. Second byte is the number of keys to remove. If all keys are removed then secure boot is disabled and insecure firmware can be loaded. | */
    GET_PUBLIC_KEYS=3, /* Get current public keys from the bootloader. Command data consists of two bytes, first byte is index of first public key to fetch, 2nd byte is number of keys to fetch. Total data needs to fit in data portion of reply (max 6 keys for 32 byte keys). Reply data has the index of the first key in the first byte, followed by the keys. Returned keys may be less than the number of keys requested if there are less keys installed than requested. | */
    SET_PUBLIC_KEYS=4, /* Set current public keys in the bootloader. Data consists of a one byte public key index followed by the public keys. With 32 byte keys this allows for up to 6 keys to be set in one request. Keys outside of the range that is being set will remain unchanged. | */
    ...
    SET_REMOTEID_CONFIG=6, /* Set config data for remote ID module. This command should be sent to the component ID of the flight controller which will forward it to the RemoteID module either over mavlink or DroneCAN. Data format is specific to the RemoteID implementation, see RemoteID firmware documentation for details. | */
    FLASH_BOOTLOADER=7, /* Flash bootloader from local storage. Data is the filename to use for the bootloader. This is intended to be used with MAVFtp to upload a new bootloader to a microSD before flashing. | */
};

//! SECURE_COMMAND_OP ENUM_END
constexpr auto SECURE_COMMAND_OP_ENUM_END = 8;
...
constexpr auto RALLY_FLAGS_ENUM_END = 25;
...
enum class EKF_STATUS_FLAGS : uint16_t
{
    ...
    GPS_GLITCHING=32768, /* Set if EKF believes the GPS input data is faulty. | */
};

//! EKF_STATUS_FLAGS ENUM_END
constexpr auto EKF_STATUS_FLAGS_ENUM_END = 32769;
...
enum class PLANE_MODE
{
    ...
    TRAINING=3, /* TRAINING | */
    ACRO=4, /* ACRO | */
    FLY_BY_WIRE_A=5, /* FBWA | */
    FLY_BY_WIRE_B=6, /* FBWB | */
    CRUISE=7, /* CRUISE | */
    AUTOTUNE=8, /* AUTOTUNE | */
    AUTO=10, /* AUTO | */
    RTL=11, /* RTL | */
    LOITER=12, /* LOITER | */
    TAKEOFF=13, /* TAKEOFF | */
    AVOID_ADSB=14, /* AVOID ADSB | */
    GUIDED=15, /* GUIDED | */
    INITIALIZING=16, /* INITIALISING | */
    QSTABILIZE=17, /* QSTABILIZE | */
    QHOVER=18, /* QHOVER | */
    QLOITER=19, /* QLOITER | */
    QLAND=20, /* QLAND | */
    QRTL=21, /* QRTL | */
    QAUTOTUNE=22, /* QAUTOTUNE | */
    QACRO=23, /* QACRO | */
    THERMAL=24, /* THERMAL | */
    LOITER_ALT_QLAND=25, /* LOITER2QLAND | */
    AUTOLAND=26, /* AUTOLAND | */
};

//! PLANE_MODE ENUM_END
constexpr auto PLANE_MODE_ENUM_END = 27;
...
enum class COPTER_MODE
{
    ...
    BRAKE=17, /* BRAKE | */
    THROW=18, /* THROW | */
    AVOID_ADSB=19, /* AVOID ADSB | */
    GUIDED_NOGPS=20, /* GUIDED NOGPS | */
    SMART_RTL=21, /* SMARTRTL | */
    FLOWHOLD=22, /* FLOWHOLD | */
    FOLLOW=23, /* FOLLOW | */
    ZIGZAG=24, /* ZIGZAG | */
    SYSTEMID=25, /* SYSTEMID | */
    AUTOROTATE=26, /* AUTOROTATE | */
    AUTO_RTL=27, /* AUTO RTL | */
    TURTLE=28, /* TURTLE | */
};

//! COPTER_MODE ENUM_END
constexpr auto COPTER_MODE_ENUM_END = 29;
...
enum class SUB_MODE
{
    ...
    POSHOLD=16, /* POSHOLD | */
    MANUAL=19, /* MANUAL | */
    MOTORDETECT=20, /* MOTORDETECT | */
    SURFTRAK=21, /* SURFTRAK | */
};

//! SUB_MODE ENUM_END
constexpr auto SUB_MODE_ENUM_END = 22;
...
#include "./mavlink_msg_secure_command.hpp"
#include "./mavlink_msg_secure_command_reply.hpp"
...
#include "./mavlink_msg_esc_telemetry_13_to_16.hpp"
#include "./mavlink_msg_esc_telemetry_17_to_20.hpp"
#include "./mavlink_msg_esc_telemetry_21_to_24.hpp"
#include "./mavlink_msg_esc_telemetry_25_to_28.hpp"
#include "./mavlink_msg_esc_telemetry_29_to_32.hpp"

// base include
#include "../common/common.hpp"
#include "../uAvionix/uAvionix.hpp"
#include "../icarous/icarous.hpp"
#include "../loweheiser/loweheiser.hpp"
#include "../cubepilot/cubepilot.hpp"
#include "../csAirLink/csAirLink.hpp"
