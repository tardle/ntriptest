...
set(mavlink_DIALECTS ASLUAV;AVSSUAS;all;ardupilotmega;common;csAirLink;cubepilot;development;icarous;loweheiser;matrixpilot;paparazzi;standard;storm32;uAvionix;ualberta)
set(mavlink2_DIALECTS ASLUAV;AVSSUAS;all;ardupilotmega;common;csAirLink;cubepilot;development;icarous;loweheiser;matrixpilot;paparazzi;standard;storm32;uAvionix;ualberta)

foreach(lib )
  set(onelib "${lib}-NOTFOUND")
  find_library(onelib ${lib}
      PATHS "/home/tardle/ntriptest/install/mavlink/lib"
    NO_DEFAULT_PATH
    )
  if(NOT onelib)
