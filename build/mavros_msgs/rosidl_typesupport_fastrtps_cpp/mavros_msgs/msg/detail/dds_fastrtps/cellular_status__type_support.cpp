...
#include "mavros_msgs/msg/detail/cellular_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mavros_msgs::msg::CellularStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mavros_msgs::msg::CellularStatus & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs::msg::CellularStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mavros_msgs::msg::CellularStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mavros_msgs::msg::CellularStatus *>(
    untyped_ros_message);
...
{
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_CellularStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, msg, CellularStatus)() {
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_CellularStatus__handle;
}
