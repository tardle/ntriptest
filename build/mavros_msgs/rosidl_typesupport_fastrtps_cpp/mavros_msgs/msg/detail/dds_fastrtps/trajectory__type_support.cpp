...
#include "mavros_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mavros_msgs::msg::PositionTarget &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
// functions for mavros_msgs::msg::PositionTarget already declared above
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 5;
    size_t item_size = sizeof(ros_message.point_valid[0]);
  ...
  {
    size_t array_size = 5;
    size_t item_size = sizeof(ros_message.time_horizon[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: point_1
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mavros_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PositionTarget(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs::msg::Trajectory;
    is_plain =
      (
      offsetof(DataType, time_horizon) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const mavros_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mavros_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, msg, Trajectory)() {
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
