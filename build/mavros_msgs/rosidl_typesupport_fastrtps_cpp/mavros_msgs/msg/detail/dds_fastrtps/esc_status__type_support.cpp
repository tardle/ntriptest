...
#include "mavros_msgs/msg/detail/esc_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mavros_msgs::msg::ESCStatusItem &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mavros_msgs::msg::ESCStatusItem &);
size_t get_serialized_size(
  const mavros_msgs::msg::ESCStatusItem &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const mavros_msgs::msg::ESCStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mavros_msgs::msg::ESCStatus & ros_message)
{
  // Member: header
  ...
  // Member: esc_status
  {
    ...
    ros_message.esc_status.resize(size);
    for (size_t i = 0; i < size; i++) {
      mavros_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.esc_status[i]);
    }
  }
  ...
  // Member: esc_status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.esc_status[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: esc_status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mavros_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ESCStatusItem(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs::msg::ESCStatus;
    is_plain =
      (
      offsetof(DataType, esc_status) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const mavros_msgs::msg::ESCStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mavros_msgs::msg::ESCStatus *>(
    untyped_ros_message);
...
{
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_ESCStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, msg, ESCStatus)() {
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_ESCStatus__handle;
}
