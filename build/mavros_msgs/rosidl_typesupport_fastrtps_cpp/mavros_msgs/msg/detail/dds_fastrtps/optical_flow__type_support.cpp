...
#include "mavros_msgs/msg/detail/optical_flow__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs::msg::OpticalFlow;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mavros_msgs::msg::OpticalFlow *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mavros_msgs::msg::OpticalFlow *>(
    untyped_ros_message);
...
static size_t _OpticalFlow__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_OpticalFlow(full_bounded, is_plain, 0);
...
{
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_OpticalFlow__handle;
}
