  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs::msg::PlayTuneV2;
    is_plain =
      (
      offsetof(DataType, tune) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _PlayTuneV2__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_PlayTuneV2(full_bounded, is_plain, 0);
