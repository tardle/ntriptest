...
#include "mavros_msgs/msg/detail/rtk_baseline__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mavros_msgs
max_serialized_size_RTKBaseline(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs::msg::RTKBaseline;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mavros_msgs::msg::RTKBaseline *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mavros_msgs::msg::RTKBaseline *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RTKBaseline__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mavros_msgs::msg::RTKBaseline *>(
...
static size_t _RTKBaseline__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_RTKBaseline(full_bounded, is_plain, 0);
...
{
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_RTKBaseline__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, msg, RTKBaseline)() {
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_RTKBaseline__handle;
}
