  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs::msg::ADSBVehicle;
    is_plain =
      (
      offsetof(DataType, squawk) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ADSBVehicle__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ADSBVehicle(full_bounded, is_plain, 0);
