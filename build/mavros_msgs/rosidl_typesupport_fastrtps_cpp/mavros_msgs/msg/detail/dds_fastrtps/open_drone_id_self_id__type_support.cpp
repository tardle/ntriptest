...
#include "mavros_msgs/msg/detail/open_drone_id_self_id__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mavros_msgs::msg::OpenDroneIDSelfID & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mavros_msgs::msg::OpenDroneIDSelfID & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs::msg::OpenDroneIDSelfID;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mavros_msgs::msg::OpenDroneIDSelfID *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mavros_msgs::msg::OpenDroneIDSelfID *>(
    untyped_ros_message);
...
{
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_OpenDroneIDSelfID__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, msg, OpenDroneIDSelfID)() {
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_OpenDroneIDSelfID__handle;
}
