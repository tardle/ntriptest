  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs::msg::ParamValue;
    is_plain =
      (
      offsetof(DataType, real) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ParamValue__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ParamValue(full_bounded, is_plain, 0);
