...
#include "mavros_msgs/msg/detail/gimbal_device_set_attitude__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mavros_msgs::msg::GimbalDeviceSetAttitude & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mavros_msgs::msg::GimbalDeviceSetAttitude & ros_message)
{
  // Member: target_system
  cdr >> ros_message.target_system;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs::msg::GimbalDeviceSetAttitude;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mavros_msgs::msg::GimbalDeviceSetAttitude *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mavros_msgs::msg::GimbalDeviceSetAttitude *>(
    untyped_ros_message);
...
{
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_GimbalDeviceSetAttitude__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, msg, GimbalDeviceSetAttitude)() {
  return &mavros_msgs::msg::typesupport_fastrtps_cpp::_GimbalDeviceSetAttitude__handle;
}
