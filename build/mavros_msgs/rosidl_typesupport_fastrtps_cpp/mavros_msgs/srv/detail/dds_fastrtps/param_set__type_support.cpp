...
#include "mavros_msgs/srv/detail/param_set__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mavros_msgs
max_serialized_size_ParamSet_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs::srv::ParamSet_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mavros_msgs::srv::ParamSet_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mavros_msgs::srv::ParamSet_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ParamSet_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mavros_msgs::srv::ParamSet_Request *>(
...
static size_t _ParamSet_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ParamSet_Request(full_bounded, is_plain, 0);
...
{
  return &mavros_msgs::srv::typesupport_fastrtps_cpp::_ParamSet_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, srv, ParamSet_Request)() {
  return &mavros_msgs::srv::typesupport_fastrtps_cpp::_ParamSet_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for mavros_msgs::msg::ParamValue already declared above
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mavros_msgs
max_serialized_size_ParamSet_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mavros_msgs::srv::ParamSet_Response;
    is_plain =
      (
      offsetof(DataType, value) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const mavros_msgs::srv::ParamSet_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mavros_msgs::srv::ParamSet_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ParamSet_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mavros_msgs::srv::ParamSet_Response *>(
...
static size_t _ParamSet_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ParamSet_Response(full_bounded, is_plain, 0);
...
{
  return &mavros_msgs::srv::typesupport_fastrtps_cpp::_ParamSet_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, srv, ParamSet_Response)() {
  return &mavros_msgs::srv::typesupport_fastrtps_cpp::_ParamSet_Response__handle;
}
...
{
  return &mavros_msgs::srv::typesupport_fastrtps_cpp::_ParamSet__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, srv, ParamSet)() {
  return &mavros_msgs::srv::typesupport_fastrtps_cpp::_ParamSet__handle;
}
