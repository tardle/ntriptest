...
class Metaclass_ESCTelemetryItem(type):
    """Metaclass of message 'ESCTelemetryItem'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__esc_telemetry_item
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__esc_telemetry_item
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__esc_telemetry_item
            cls._TYPE_SUPPORT = module.type_support_msg__msg__esc_telemetry_item
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__esc_telemetry_item
...
class ESCTelemetryItem(metaclass=Metaclass_ESCTelemetryItem):
    """Message class 'ESCTelemetryItem'."""
