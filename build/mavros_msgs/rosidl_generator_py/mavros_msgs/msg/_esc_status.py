...
class Metaclass_ESCStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mavros_msgs.msg import ESCStatusItem
            if ESCStatusItem.__class__._TYPE_SUPPORT is None:
                ESCStatusItem.__class__.__import_type_support__()
...
class ESCStatus(metaclass=Metaclass_ESCStatus):
    ...
    _fields_and_field_types = {
        ...
        'esc_status': 'sequence<mavros_msgs/ESCStatusItem>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mavros_msgs', 'msg'], 'ESCStatusItem')),  # noqa: E501
    )
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.esc_status != other.esc_status:
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, ESCStatusItem) for v in value) and
                 True), \
                "The 'esc_status' field must be a set or sequence and each value of type 'ESCStatusItem'"
