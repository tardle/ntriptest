...
class Metaclass_WheelOdomStamped(type):
    """Metaclass of message 'WheelOdomStamped'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'mavros_msgs.msg.WheelOdomStamped')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__wheel_odom_stamped
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__wheel_odom_stamped
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__wheel_odom_stamped
            cls._TYPE_SUPPORT = module.type_support_msg__msg__wheel_odom_stamped
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__wheel_odom_stamped
...
class WheelOdomStamped(metaclass=Metaclass_WheelOdomStamped):
    """Message class 'WheelOdomStamped'."""
