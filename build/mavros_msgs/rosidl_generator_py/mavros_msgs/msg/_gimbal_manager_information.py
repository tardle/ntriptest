...
class Metaclass_GimbalManagerInformation(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'CAP_FLAGS_CAN_POINT_LOCATION_LOCAL': cls.__constants['CAP_FLAGS_CAN_POINT_LOCATION_LOCAL'],
            'CAP_FLAGS_CAN_POINT_LOCATION_GLOBAL': cls.__constants['CAP_FLAGS_CAN_POINT_LOCATION_GLOBAL'],
        }

    @property
    def CAP_FLAGS_HAS_RETRACT(self):
        """Message constant 'CAP_FLAGS_HAS_RETRACT'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_HAS_RETRACT']

    @property
    def CAP_FLAGS_HAS_NEUTRAL(self):
        """Message constant 'CAP_FLAGS_HAS_NEUTRAL'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_HAS_NEUTRAL']

    @property
    def CAP_FLAGS_HAS_ROLL_AXIS(self):
        """Message constant 'CAP_FLAGS_HAS_ROLL_AXIS'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_HAS_ROLL_AXIS']

    @property
    def CAP_FLAGS_HAS_ROLL_FOLLOW(self):
        """Message constant 'CAP_FLAGS_HAS_ROLL_FOLLOW'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_HAS_ROLL_FOLLOW']

    @property
    def CAP_FLAGS_HAS_ROLL_LOCK(self):
        """Message constant 'CAP_FLAGS_HAS_ROLL_LOCK'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_HAS_ROLL_LOCK']

    @property
    def CAP_FLAGS_HAS_PITCH_AXIS(self):
        """Message constant 'CAP_FLAGS_HAS_PITCH_AXIS'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_HAS_PITCH_AXIS']

    @property
    def CAP_FLAGS_HAS_PITCH_FOLLOW(self):
        """Message constant 'CAP_FLAGS_HAS_PITCH_FOLLOW'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_HAS_PITCH_FOLLOW']

    @property
    def CAP_FLAGS_HAS_PITCH_LOCK(self):
        """Message constant 'CAP_FLAGS_HAS_PITCH_LOCK'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_HAS_PITCH_LOCK']

    @property
    def CAP_FLAGS_HAS_YAW_AXIS(self):
        """Message constant 'CAP_FLAGS_HAS_YAW_AXIS'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_HAS_YAW_AXIS']

    @property
    def CAP_FLAGS_HAS_YAW_FOLLOW(self):
        """Message constant 'CAP_FLAGS_HAS_YAW_FOLLOW'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_HAS_YAW_FOLLOW']

    @property
    def CAP_FLAGS_HAS_YAW_LOCK(self):
        """Message constant 'CAP_FLAGS_HAS_YAW_LOCK'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_HAS_YAW_LOCK']

    @property
    def CAP_FLAGS_SUPPORTS_INFINITE_YAW(self):
        """Message constant 'CAP_FLAGS_SUPPORTS_INFINITE_YAW'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_SUPPORTS_INFINITE_YAW']

    @property
    def CAP_FLAGS_CAN_POINT_LOCATION_LOCAL(self):
        """Message constant 'CAP_FLAGS_CAN_POINT_LOCATION_LOCAL'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_CAN_POINT_LOCATION_LOCAL']

    @property
    def CAP_FLAGS_CAN_POINT_LOCATION_GLOBAL(self):
        """Message constant 'CAP_FLAGS_CAN_POINT_LOCATION_GLOBAL'."""
        return Metaclass_GimbalManagerInformation.__constants['CAP_FLAGS_CAN_POINT_LOCATION_GLOBAL']
...
class GimbalManagerInformation(metaclass=Metaclass_GimbalManagerInformation):
    ...
    Constants:
      ...
      CAP_FLAGS_CAN_POINT_LOCATION_LOCAL
      CAP_FLAGS_CAN_POINT_LOCATION_GLOBAL
    """
