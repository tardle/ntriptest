...
void mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_init_function(
...
void mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_fini_function(void * message_memory)
{
  mavros_msgs__srv__CommandInt_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_message_member_array[12] = {
  {
    "broadcast",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_message_members = {
  "mavros_msgs__srv",  // message namespace
  "CommandInt_Request",  // message name
  12,  // number of fields
  sizeof(mavros_msgs__srv__CommandInt_Request),
  mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_message_member_array,  // message members
  mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_message_type_support_handle = {
  0,
  &mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mavros_msgs, srv, CommandInt_Request)() {
  if (!mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_message_type_support_handle.typesupport_identifier) {
    mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &mavros_msgs__srv__CommandInt_Request__rosidl_typesupport_introspection_c__CommandInt_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_fini_function(void * message_memory)
{
  mavros_msgs__srv__CommandInt_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_message_member_array[1] = {
  {
    "success",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_BOOLEAN,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_message_members = {
  "mavros_msgs__srv",  // message namespace
  "CommandInt_Response",  // message name
  1,  // number of fields
  sizeof(mavros_msgs__srv__CommandInt_Response),
  mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_message_member_array,  // message members
  mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_message_type_support_handle = {
  0,
  &mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mavros_msgs, srv, CommandInt_Response)() {
  if (!mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_message_type_support_handle.typesupport_identifier) {
    mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &mavros_msgs__srv__CommandInt_Response__rosidl_typesupport_introspection_c__CommandInt_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
