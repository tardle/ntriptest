...
#include "mavros_msgs/msg/detail/rc_out__rosidl_typesupport_fastrtps_c.h"
...
using _RCOut__ros_msg_type = mavros_msgs__msg__RCOut;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RCOut__ros_msg_type * ros_message = static_cast<const _RCOut__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RCOut__ros_msg_type * ros_message = static_cast<_RCOut__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_mavros_msgs__msg__RCOut(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RCOut__ros_msg_type * ros_message = static_cast<const _RCOut__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RCOut__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mavros_msgs__msg__RCOut(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mavros_msgs
size_t max_serialized_size_mavros_msgs__msg__RCOut(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs__msg__RCOut;
    is_plain =
      (
...
static size_t _RCOut__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_mavros_msgs__msg__RCOut(
...
static message_type_support_callbacks_t __callbacks_RCOut = {
  "mavros_msgs::msg",
  "RCOut",
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mavros_msgs, msg, RCOut)() {
