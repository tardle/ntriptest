...
#include "mavros_msgs/msg/detail/open_drone_id_self_id__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // description, id_or_mac
#include "rosidl_runtime_c/string_functions.h"  // description, id_or_mac
...
using _OpenDroneIDSelfID__ros_msg_type = mavros_msgs__msg__OpenDroneIDSelfID;
...
size_t get_serialized_size_mavros_msgs__msg__OpenDroneIDSelfID(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _OpenDroneIDSelfID__ros_msg_type * ros_message = static_cast<const _OpenDroneIDSelfID__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _OpenDroneIDSelfID__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mavros_msgs__msg__OpenDroneIDSelfID(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mavros_msgs
size_t max_serialized_size_mavros_msgs__msg__OpenDroneIDSelfID(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs__msg__OpenDroneIDSelfID;
    is_plain =
      (
...
static size_t _OpenDroneIDSelfID__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mavros_msgs__msg__OpenDroneIDSelfID(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mavros_msgs, msg, OpenDroneIDSelfID)() {
