...
#include "mavros_msgs/msg/detail/rtcm__rosidl_typesupport_fastrtps_c.h"
...
using _RTCM__ros_msg_type = mavros_msgs__msg__RTCM;
...
size_t get_serialized_size_mavros_msgs__msg__RTCM(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RTCM__ros_msg_type * ros_message = static_cast<const _RTCM__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RTCM__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mavros_msgs__msg__RTCM(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mavros_msgs
size_t max_serialized_size_mavros_msgs__msg__RTCM(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs__msg__RTCM;
    is_plain =
      (
...
static size_t _RTCM__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mavros_msgs__msg__RTCM(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mavros_msgs, msg, RTCM)() {
