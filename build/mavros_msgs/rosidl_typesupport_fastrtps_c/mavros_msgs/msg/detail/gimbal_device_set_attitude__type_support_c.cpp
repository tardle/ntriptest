...
#include "mavros_msgs/msg/detail/gimbal_device_set_attitude__rosidl_typesupport_fastrtps_c.h"
...
using _GimbalDeviceSetAttitude__ros_msg_type = mavros_msgs__msg__GimbalDeviceSetAttitude;
...
size_t get_serialized_size_mavros_msgs__msg__GimbalDeviceSetAttitude(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GimbalDeviceSetAttitude__ros_msg_type * ros_message = static_cast<const _GimbalDeviceSetAttitude__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GimbalDeviceSetAttitude__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mavros_msgs__msg__GimbalDeviceSetAttitude(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mavros_msgs
size_t max_serialized_size_mavros_msgs__msg__GimbalDeviceSetAttitude(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs__msg__GimbalDeviceSetAttitude;
    is_plain =
      (
...
static size_t _GimbalDeviceSetAttitude__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mavros_msgs__msg__GimbalDeviceSetAttitude(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mavros_msgs, msg, GimbalDeviceSetAttitude)() {
