...
#include "mavros_msgs/msg/detail/optical_flow__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // flow, flow_comp_m, flow_rate
...
using _OpticalFlow__ros_msg_type = mavros_msgs__msg__OpticalFlow;
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Vector3(
    &(ros_message->flow_comp_m), current_alignment);
  // field.name quality
  {
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Vector3(
    &(ros_message->flow_rate), current_alignment);
...
static uint32_t _OpticalFlow__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mavros_msgs__msg__OpticalFlow(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs__msg__OpticalFlow;
    is_plain =
      (
...
static size_t _OpticalFlow__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mavros_msgs__msg__OpticalFlow(
