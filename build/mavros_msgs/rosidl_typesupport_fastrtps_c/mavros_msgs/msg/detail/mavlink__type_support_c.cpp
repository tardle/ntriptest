  ...
  void * untyped_ros_message)
{
  ...
  // Field name: payload64
  {
    ...
    if (!rosidl_runtime_c__uint64__Sequence__init(&ros_message->payload64, size)) {
      fprintf(stderr, "failed to create array for field 'payload64'");
      return false;
    }
    auto array_ptr = ros_message->payload64.data;
  ...
  // Field name: signature
  {
    ...
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->signature, size)) {
      fprintf(stderr, "failed to create array for field 'signature'");
      return false;
    }
    auto array_ptr = ros_message->signature.data;
    cdr.deserializeArray(array_ptr, size);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs__msg__Mavlink;
    is_plain =
      (
...
static size_t _Mavlink__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mavros_msgs__msg__Mavlink(
