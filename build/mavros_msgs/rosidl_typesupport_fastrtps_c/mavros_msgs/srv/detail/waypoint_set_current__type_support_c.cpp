  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavros_msgs__srv__WaypointSetCurrent_Request;
    is_plain =
      (
...
static size_t _WaypointSetCurrent_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mavros_msgs__srv__WaypointSetCurrent_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mavros_msgs__srv__WaypointSetCurrent_Response;
    is_plain =
      (
...
static size_t _WaypointSetCurrent_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mavros_msgs__srv__WaypointSetCurrent_Response(
    full_bounded, is_plain, 0);
