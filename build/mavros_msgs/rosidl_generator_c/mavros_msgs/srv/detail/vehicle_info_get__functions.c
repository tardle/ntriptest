...
bool
mavros_msgs__srv__VehicleInfoGet_Request__are_equal(const mavros_msgs__srv__VehicleInfoGet_Request * lhs, const mavros_msgs__srv__VehicleInfoGet_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
mavros_msgs__srv__VehicleInfoGet_Request__copy(
  const mavros_msgs__srv__VehicleInfoGet_Request * input,
  mavros_msgs__srv__VehicleInfoGet_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
mavros_msgs__srv__VehicleInfoGet_Request__create()
{
  ...
  mavros_msgs__srv__VehicleInfoGet_Request * msg = (mavros_msgs__srv__VehicleInfoGet_Request *)allocator.allocate(sizeof(mavros_msgs__srv__VehicleInfoGet_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__srv__VehicleInfoGet_Request__Sequence__init(mavros_msgs__srv__VehicleInfoGet_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__srv__VehicleInfoGet_Request *)allocator.zero_allocate(size, sizeof(mavros_msgs__srv__VehicleInfoGet_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mavros_msgs__srv__VehicleInfoGet_Request__Sequence * array = (mavros_msgs__srv__VehicleInfoGet_Request__Sequence *)allocator.allocate(sizeof(mavros_msgs__srv__VehicleInfoGet_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
mavros_msgs__srv__VehicleInfoGet_Request__Sequence__are_equal(const mavros_msgs__srv__VehicleInfoGet_Request__Sequence * lhs, const mavros_msgs__srv__VehicleInfoGet_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mavros_msgs__srv__VehicleInfoGet_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
mavros_msgs__srv__VehicleInfoGet_Request__Sequence__copy(
  const mavros_msgs__srv__VehicleInfoGet_Request__Sequence * input,
  mavros_msgs__srv__VehicleInfoGet_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mavros_msgs__srv__VehicleInfoGet_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mavros_msgs__srv__VehicleInfoGet_Request * data =
      (mavros_msgs__srv__VehicleInfoGet_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mavros_msgs__srv__VehicleInfoGet_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mavros_msgs__srv__VehicleInfoGet_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mavros_msgs__srv__VehicleInfoGet_Request__copy(
...
bool
mavros_msgs__srv__VehicleInfoGet_Response__are_equal(const mavros_msgs__srv__VehicleInfoGet_Response * lhs, const mavros_msgs__srv__VehicleInfoGet_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // vehicles
  if (!mavros_msgs__msg__VehicleInfo__Sequence__are_equal(
...
bool
mavros_msgs__srv__VehicleInfoGet_Response__copy(
  const mavros_msgs__srv__VehicleInfoGet_Response * input,
  mavros_msgs__srv__VehicleInfoGet_Response * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // vehicles
  if (!mavros_msgs__msg__VehicleInfo__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mavros_msgs__srv__VehicleInfoGet_Response * msg = (mavros_msgs__srv__VehicleInfoGet_Response *)allocator.allocate(sizeof(mavros_msgs__srv__VehicleInfoGet_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__srv__VehicleInfoGet_Response__Sequence__init(mavros_msgs__srv__VehicleInfoGet_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__srv__VehicleInfoGet_Response *)allocator.zero_allocate(size, sizeof(mavros_msgs__srv__VehicleInfoGet_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mavros_msgs__srv__VehicleInfoGet_Response__Sequence * array = (mavros_msgs__srv__VehicleInfoGet_Response__Sequence *)allocator.allocate(sizeof(mavros_msgs__srv__VehicleInfoGet_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
mavros_msgs__srv__VehicleInfoGet_Response__Sequence__are_equal(const mavros_msgs__srv__VehicleInfoGet_Response__Sequence * lhs, const mavros_msgs__srv__VehicleInfoGet_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mavros_msgs__srv__VehicleInfoGet_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
mavros_msgs__srv__VehicleInfoGet_Response__Sequence__copy(
  const mavros_msgs__srv__VehicleInfoGet_Response__Sequence * input,
  mavros_msgs__srv__VehicleInfoGet_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mavros_msgs__srv__VehicleInfoGet_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mavros_msgs__srv__VehicleInfoGet_Response * data =
      (mavros_msgs__srv__VehicleInfoGet_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mavros_msgs__srv__VehicleInfoGet_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mavros_msgs__srv__VehicleInfoGet_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mavros_msgs__srv__VehicleInfoGet_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
