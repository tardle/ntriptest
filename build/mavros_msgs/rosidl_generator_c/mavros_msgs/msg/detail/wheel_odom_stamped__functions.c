...
mavros_msgs__msg__WheelOdomStamped__init(mavros_msgs__msg__WheelOdomStamped * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    mavros_msgs__msg__WheelOdomStamped__fini(msg);
    return false;
  }
  // data
...
mavros_msgs__msg__WheelOdomStamped__create()
{
  ...
  mavros_msgs__msg__WheelOdomStamped * msg = (mavros_msgs__msg__WheelOdomStamped *)allocator.allocate(sizeof(mavros_msgs__msg__WheelOdomStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mavros_msgs__msg__WheelOdomStamped));
  bool success = mavros_msgs__msg__WheelOdomStamped__init(msg);
  if (!success) {
...
mavros_msgs__msg__WheelOdomStamped__Sequence__init(mavros_msgs__msg__WheelOdomStamped__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mavros_msgs__msg__WheelOdomStamped * data = NULL;

  if (size) {
    data = (mavros_msgs__msg__WheelOdomStamped *)allocator.zero_allocate(size, sizeof(mavros_msgs__msg__WheelOdomStamped), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mavros_msgs__msg__WheelOdomStamped__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mavros_msgs__msg__WheelOdomStamped__fini(&data[i - 1]);
      }
...
mavros_msgs__msg__WheelOdomStamped__Sequence__fini(mavros_msgs__msg__WheelOdomStamped__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mavros_msgs__msg__WheelOdomStamped__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mavros_msgs__msg__WheelOdomStamped__Sequence * array = (mavros_msgs__msg__WheelOdomStamped__Sequence *)allocator.allocate(sizeof(mavros_msgs__msg__WheelOdomStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mavros_msgs__msg__WheelOdomStamped__Sequence__init(array, size);
  if (!success) {
...
mavros_msgs__msg__WheelOdomStamped__Sequence__destroy(mavros_msgs__msg__WheelOdomStamped__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mavros_msgs__msg__WheelOdomStamped__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mavros_msgs__msg__WheelOdomStamped__Sequence__are_equal(const mavros_msgs__msg__WheelOdomStamped__Sequence * lhs, const mavros_msgs__msg__WheelOdomStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mavros_msgs__msg__WheelOdomStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mavros_msgs__msg__WheelOdomStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mavros_msgs__msg__WheelOdomStamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mavros_msgs__msg__WheelOdomStamped * data =
      (mavros_msgs__msg__WheelOdomStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mavros_msgs__msg__WheelOdomStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mavros_msgs__msg__WheelOdomStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mavros_msgs__msg__WheelOdomStamped__copy(
