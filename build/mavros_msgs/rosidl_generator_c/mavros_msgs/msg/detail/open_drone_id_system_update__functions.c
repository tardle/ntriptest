...
mavros_msgs__msg__OpenDroneIDSystemUpdate__init(mavros_msgs__msg__OpenDroneIDSystemUpdate * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    mavros_msgs__msg__OpenDroneIDSystemUpdate__fini(msg);
    return false;
  }
  // operator_latitude
  // operator_longitude
...
mavros_msgs__msg__OpenDroneIDSystemUpdate__create()
{
  ...
  mavros_msgs__msg__OpenDroneIDSystemUpdate * msg = (mavros_msgs__msg__OpenDroneIDSystemUpdate *)allocator.allocate(sizeof(mavros_msgs__msg__OpenDroneIDSystemUpdate), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mavros_msgs__msg__OpenDroneIDSystemUpdate));
  bool success = mavros_msgs__msg__OpenDroneIDSystemUpdate__init(msg);
  if (!success) {
...
mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence__init(mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mavros_msgs__msg__OpenDroneIDSystemUpdate * data = NULL;

  if (size) {
    data = (mavros_msgs__msg__OpenDroneIDSystemUpdate *)allocator.zero_allocate(size, sizeof(mavros_msgs__msg__OpenDroneIDSystemUpdate), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mavros_msgs__msg__OpenDroneIDSystemUpdate__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mavros_msgs__msg__OpenDroneIDSystemUpdate__fini(&data[i - 1]);
      }
...
mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence__fini(mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mavros_msgs__msg__OpenDroneIDSystemUpdate__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence * array = (mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence *)allocator.allocate(sizeof(mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence__init(array, size);
  if (!success) {
...
mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence__destroy(mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence__are_equal(const mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence * lhs, const mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mavros_msgs__msg__OpenDroneIDSystemUpdate__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mavros_msgs__msg__OpenDroneIDSystemUpdate__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mavros_msgs__msg__OpenDroneIDSystemUpdate);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mavros_msgs__msg__OpenDroneIDSystemUpdate * data =
      (mavros_msgs__msg__OpenDroneIDSystemUpdate *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mavros_msgs__msg__OpenDroneIDSystemUpdate__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mavros_msgs__msg__OpenDroneIDSystemUpdate__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mavros_msgs__msg__OpenDroneIDSystemUpdate__copy(
