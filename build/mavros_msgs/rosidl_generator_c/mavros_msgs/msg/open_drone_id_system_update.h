...
#ifndef MAVROS_MSGS__MSG__OPEN_DRONE_ID_SYSTEM_UPDATE_H_
#define MAVROS_MSGS__MSG__OPEN_DRONE_ID_SYSTEM_UPDATE_H_
...
#endif  // MAVROS_MSGS__MSG__OPEN_DRONE_ID_SYSTEM_UPDATE_H_
