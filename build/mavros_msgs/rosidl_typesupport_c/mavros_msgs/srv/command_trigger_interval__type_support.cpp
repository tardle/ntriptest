...
static const _CommandTriggerInterval_Request_type_support_symbol_names_t _CommandTriggerInterval_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mavros_msgs, srv, CommandTriggerInterval_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mavros_msgs, srv, CommandTriggerInterval_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mavros_msgs, srv, CommandTriggerInterval_Request)() {
  return &::mavros_msgs::srv::rosidl_typesupport_c::CommandTriggerInterval_Request_message_type_support_handle;
}
...
static const _CommandTriggerInterval_Response_type_support_symbol_names_t _CommandTriggerInterval_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mavros_msgs, srv, CommandTriggerInterval_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mavros_msgs, srv, CommandTriggerInterval_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mavros_msgs, srv, CommandTriggerInterval_Response)() {
  return &::mavros_msgs::srv::rosidl_typesupport_c::CommandTriggerInterval_Response_message_type_support_handle;
}
...
static const _CommandTriggerInterval_type_support_symbol_names_t _CommandTriggerInterval_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mavros_msgs, srv, CommandTriggerInterval)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mavros_msgs, srv, CommandTriggerInterval)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mavros_msgs, srv, CommandTriggerInterval)() {
  return &::mavros_msgs::srv::rosidl_typesupport_c::CommandTriggerInterval_service_type_support_handle;
}
