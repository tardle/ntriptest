...
static const _OpenDroneIDSelfID_type_support_symbol_names_t _OpenDroneIDSelfID_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mavros_msgs, msg, OpenDroneIDSelfID)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mavros_msgs, msg, OpenDroneIDSelfID)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mavros_msgs, msg, OpenDroneIDSelfID)() {
  return &::mavros_msgs::msg::rosidl_typesupport_c::OpenDroneIDSelfID_message_type_support_handle;
}
