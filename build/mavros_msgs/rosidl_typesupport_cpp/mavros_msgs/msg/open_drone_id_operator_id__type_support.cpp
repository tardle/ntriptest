...
static const _OpenDroneIDOperatorID_type_support_symbol_names_t _OpenDroneIDOperatorID_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, msg, OpenDroneIDOperatorID)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mavros_msgs, msg, OpenDroneIDOperatorID)),
  }
};
...
{
  return &::mavros_msgs::msg::rosidl_typesupport_cpp::OpenDroneIDOperatorID_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mavros_msgs, msg, OpenDroneIDOperatorID)() {
  return get_message_type_support_handle<mavros_msgs::msg::OpenDroneIDOperatorID>();
}
