...
static const _OpenDroneIDSelfID_type_support_symbol_names_t _OpenDroneIDSelfID_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mavros_msgs, msg, OpenDroneIDSelfID)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mavros_msgs, msg, OpenDroneIDSelfID)),
  }
};
...
{
  return &::mavros_msgs::msg::rosidl_typesupport_cpp::OpenDroneIDSelfID_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mavros_msgs, msg, OpenDroneIDSelfID)() {
  return get_message_type_support_handle<mavros_msgs::msg::OpenDroneIDSelfID>();
}
