...
struct ESCInfo_
{
  ...
  using _esc_info_type =
    std::vector<mavros_msgs::msg::ESCInfoItem_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mavros_msgs::msg::ESCInfoItem_<ContainerAllocator>>>;
  ...
  Type & set__esc_info(
    const std::vector<mavros_msgs::msg::ESCInfoItem_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mavros_msgs::msg::ESCInfoItem_<ContainerAllocator>>> & _arg)
  {
    this->esc_info = _arg;
    return *this;
  }
