...
#ifndef MAVROS_MSGS__MSG__DETAIL__GIMBAL_MANAGER_SET_ATTITUDE__TRAITS_HPP_
#define MAVROS_MSGS__MSG__DETAIL__GIMBAL_MANAGER_SET_ATTITUDE__TRAITS_HPP_
...
inline void to_flow_style_yaml(
  const GimbalManagerSetAttitude & msg,
  std::ostream & out)
{
  out << "{";
...
inline std::string to_yaml(const GimbalManagerSetAttitude & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const mavros_msgs::msg::GimbalManagerSetAttitude & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mavros_msgs::msg::GimbalManagerSetAttitude & msg)
{
  return mavros_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<mavros_msgs::msg::GimbalManagerSetAttitude>()
{
  return "mavros_msgs::msg::GimbalManagerSetAttitude";
}

template<>
inline const char * name<mavros_msgs::msg::GimbalManagerSetAttitude>()
{
  return "mavros_msgs/msg/GimbalManagerSetAttitude";
}

template<>
struct has_fixed_size<mavros_msgs::msg::GimbalManagerSetAttitude>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Quaternion>::value> {};

template<>
struct has_bounded_size<mavros_msgs::msg::GimbalManagerSetAttitude>
  : std::integral_constant<bool, has_bounded_size<geometry_msgs::msg::Quaternion>::value> {};

template<>
struct is_message<mavros_msgs::msg::GimbalManagerSetAttitude>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MAVROS_MSGS__MSG__DETAIL__GIMBAL_MANAGER_SET_ATTITUDE__TRAITS_HPP_
