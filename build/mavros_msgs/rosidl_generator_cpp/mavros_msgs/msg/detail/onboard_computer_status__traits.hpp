...
#ifndef MAVROS_MSGS__MSG__DETAIL__ONBOARD_COMPUTER_STATUS__TRAITS_HPP_
#define MAVROS_MSGS__MSG__DETAIL__ONBOARD_COMPUTER_STATUS__TRAITS_HPP_
...
inline void to_yaml(
  const mavros_msgs::msg::OnboardComputerStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mavros_msgs::msg::OnboardComputerStatus & msg)
{
  return mavros_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<mavros_msgs::msg::OnboardComputerStatus>()
{
  return "mavros_msgs::msg::OnboardComputerStatus";
}

template<>
inline const char * name<mavros_msgs::msg::OnboardComputerStatus>()
{
  return "mavros_msgs/msg/OnboardComputerStatus";
}

template<>
struct has_fixed_size<mavros_msgs::msg::OnboardComputerStatus>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<mavros_msgs::msg::OnboardComputerStatus>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<mavros_msgs::msg::OnboardComputerStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MAVROS_MSGS__MSG__DETAIL__ONBOARD_COMPUTER_STATUS__TRAITS_HPP_
