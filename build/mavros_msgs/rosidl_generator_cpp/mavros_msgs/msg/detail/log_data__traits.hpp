...
inline std::string to_yaml(const LogData & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const mavros_msgs::msg::LogData & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mavros_msgs::msg::LogData & msg)
{
