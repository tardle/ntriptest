...
inline std::string to_yaml(const FileMakeDir_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const mavros_msgs::srv::FileMakeDir_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mavros_msgs::srv::FileMakeDir_Request & msg)
{
...
inline void to_flow_style_yaml(
  const FileMakeDir_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: success
...
inline std::string to_yaml(const FileMakeDir_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use mavros_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const mavros_msgs::srv::FileMakeDir_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  mavros_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use mavros_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const mavros_msgs::srv::FileMakeDir_Response & msg)
{
  return mavros_msgs::srv::to_yaml(msg);
}
