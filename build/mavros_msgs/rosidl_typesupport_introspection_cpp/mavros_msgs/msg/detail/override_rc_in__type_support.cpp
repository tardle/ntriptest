...
void fetch_function__OverrideRCIn__channels(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint16_t *>(
    get_const_function__OverrideRCIn__channels(untyped_member, index));
  auto & value = *reinterpret_cast<uint16_t *>(untyped_value);
  value = item;
}

void assign_function__OverrideRCIn__channels(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint16_t *>(
    get_function__OverrideRCIn__channels(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OverrideRCIn_message_member_array[1] = {
  {
    ...
    fetch_function__OverrideRCIn__channels,  // fetch(index, &value) function pointer
    assign_function__OverrideRCIn__channels,  // assign(index, value) function pointer
