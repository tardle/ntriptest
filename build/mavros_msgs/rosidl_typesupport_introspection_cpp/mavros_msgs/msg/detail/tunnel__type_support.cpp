...
void fetch_function__Tunnel__payload(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint8_t *>(
    get_const_function__Tunnel__payload(untyped_member, index));
  auto & value = *reinterpret_cast<uint8_t *>(untyped_value);
  value = item;
}

void assign_function__Tunnel__payload(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint8_t *>(
    get_function__Tunnel__payload(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Tunnel_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__Tunnel__payload,  // fetch(index, &value) function pointer
    assign_function__Tunnel__payload,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
