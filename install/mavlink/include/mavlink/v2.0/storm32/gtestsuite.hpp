...
TEST(storm32, AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_EXT)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::storm32::msg::AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_EXT packet_in{};
    packet_in.target_system = 65;
    packet_in.target_component = 132;
    packet_in.time_boot_us = 93372036854775807ULL;
    packet_in.wind_x = 73.0;
    packet_in.wind_y = 101.0;
    packet_in.wind_correction_angle = 129.0;

    mavlink::storm32::msg::AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_EXT packet1{};
    mavlink::storm32::msg::AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_EXT packet2{};
    ...
    EXPECT_EQ(packet1.wind_correction_angle, packet2.wind_correction_angle);
}

#ifdef TEST_INTEROP
TEST(storm32_interop, AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_EXT)
{
    mavlink_message_t msg;
    ...
    mavlink_autopilot_state_for_gimbal_device_ext_t packet_c {
    ...
    mavlink_msg_autopilot_state_for_gimbal_device_ext_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.wind_correction_angle, packet2.wind_correction_angle);
...
TEST(storm32, MLRS_RADIO_LINK_STATS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::storm32::msg::MLRS_RADIO_LINK_STATS packet_in{};
    packet_in.target_system = 139;
    packet_in.target_component = 206;
    packet_in.flags = 17235;
    packet_in.rx_LQ_rc = 17;
    packet_in.rx_LQ_ser = 84;
    packet_in.rx_rssi1 = 151;
    packet_in.rx_snr1 = -38;
    packet_in.tx_LQ_ser = 29;
    packet_in.tx_rssi1 = 96;
    packet_in.tx_snr1 = -93;
    packet_in.rx_rssi2 = 230;
    packet_in.rx_snr2 = 41;
    packet_in.tx_rssi2 = 108;
    packet_in.tx_snr2 = -81;
    packet_in.frequency1 = 122.0;
    packet_in.frequency2 = 150.0;

    mavlink::storm32::msg::MLRS_RADIO_LINK_STATS packet1{};
    mavlink::storm32::msg::MLRS_RADIO_LINK_STATS packet2{};
    ...
    EXPECT_EQ(packet1.target_component, packet2.target_component);
    EXPECT_EQ(packet1.flags, packet2.flags);
    EXPECT_EQ(packet1.rx_LQ_rc, packet2.rx_LQ_rc);
    EXPECT_EQ(packet1.rx_LQ_ser, packet2.rx_LQ_ser);
    EXPECT_EQ(packet1.rx_rssi1, packet2.rx_rssi1);
    EXPECT_EQ(packet1.rx_snr1, packet2.rx_snr1);
    EXPECT_EQ(packet1.tx_LQ_ser, packet2.tx_LQ_ser);
    ...
    EXPECT_EQ(packet1.frequency1, packet2.frequency1);
    EXPECT_EQ(packet1.frequency2, packet2.frequency2);
}

#ifdef TEST_INTEROP
TEST(storm32_interop, MLRS_RADIO_LINK_STATS)
{
    mavlink_message_t msg;
    ...
    mavlink_mlrs_radio_link_stats_t packet_c {
         17235, 139, 206, 17, 84, 151, -38, 29, 96, -93, 230, 41, 108, -81, 122.0, 150.0
    };
    ...
    mavlink_msg_mlrs_radio_link_stats_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.target_component, packet2.target_component);
    EXPECT_EQ(packet_in.flags, packet2.flags);
    EXPECT_EQ(packet_in.rx_LQ_rc, packet2.rx_LQ_rc);
    EXPECT_EQ(packet_in.rx_LQ_ser, packet2.rx_LQ_ser);
    EXPECT_EQ(packet_in.rx_rssi1, packet2.rx_rssi1);
    EXPECT_EQ(packet_in.rx_snr1, packet2.rx_snr1);
    EXPECT_EQ(packet_in.tx_LQ_ser, packet2.tx_LQ_ser);
    ...
    EXPECT_EQ(packet_in.frequency1, packet2.frequency1);
    EXPECT_EQ(packet_in.frequency2, packet2.frequency2);
...
TEST(storm32, MLRS_RADIO_LINK_INFORMATION)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::storm32::msg::MLRS_RADIO_LINK_INFORMATION packet_in{};
    packet_in.target_system = 29;
    packet_in.target_component = 96;
    packet_in.type = 163;
    packet_in.mode = 230;
    packet_in.tx_power = 41;
    packet_in.rx_power = 108;
    packet_in.tx_frame_rate = 17235;
    packet_in.rx_frame_rate = 17339;
    packet_in.mode_str = to_char_array("OPQRS");
    packet_in.band_str = to_char_array("UVWXY");
    packet_in.tx_ser_data_rate = 17443;
    packet_in.rx_ser_data_rate = 17547;
    packet_in.tx_receive_sensitivity = 211;
    packet_in.rx_receive_sensitivity = 22;

    mavlink::storm32::msg::MLRS_RADIO_LINK_INFORMATION packet1{};
    mavlink::storm32::msg::MLRS_RADIO_LINK_INFORMATION packet2{};
    ...
    EXPECT_EQ(packet1.mode, packet2.mode);
    EXPECT_EQ(packet1.tx_power, packet2.tx_power);
    EXPECT_EQ(packet1.rx_power, packet2.rx_power);
    EXPECT_EQ(packet1.tx_frame_rate, packet2.tx_frame_rate);
    EXPECT_EQ(packet1.rx_frame_rate, packet2.rx_frame_rate);
    EXPECT_EQ(packet1.mode_str, packet2.mode_str);
    EXPECT_EQ(packet1.band_str, packet2.band_str);
    EXPECT_EQ(packet1.tx_ser_data_rate, packet2.tx_ser_data_rate);
    EXPECT_EQ(packet1.rx_ser_data_rate, packet2.rx_ser_data_rate);
    EXPECT_EQ(packet1.tx_receive_sensitivity, packet2.tx_receive_sensitivity);
    EXPECT_EQ(packet1.rx_receive_sensitivity, packet2.rx_receive_sensitivity);
}

#ifdef TEST_INTEROP
TEST(storm32_interop, MLRS_RADIO_LINK_INFORMATION)
{
    mavlink_message_t msg;
    ...
    mavlink_mlrs_radio_link_information_t packet_c {
    ...
    mavlink_msg_mlrs_radio_link_information_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.mode, packet2.mode);
    EXPECT_EQ(packet_in.tx_power, packet2.tx_power);
    EXPECT_EQ(packet_in.rx_power, packet2.rx_power);
    EXPECT_EQ(packet_in.tx_frame_rate, packet2.tx_frame_rate);
    EXPECT_EQ(packet_in.rx_frame_rate, packet2.rx_frame_rate);
    EXPECT_EQ(packet_in.mode_str, packet2.mode_str);
    EXPECT_EQ(packet_in.band_str, packet2.band_str);
    EXPECT_EQ(packet_in.tx_ser_data_rate, packet2.tx_ser_data_rate);
    EXPECT_EQ(packet_in.rx_ser_data_rate, packet2.rx_ser_data_rate);
    EXPECT_EQ(packet_in.tx_receive_sensitivity, packet2.tx_receive_sensitivity);
    EXPECT_EQ(packet_in.rx_receive_sensitivity, packet2.rx_receive_sensitivity);
...
TEST(storm32, MLRS_RADIO_LINK_FLOW_CONTROL)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::storm32::msg::MLRS_RADIO_LINK_FLOW_CONTROL packet_in{};
    packet_in.tx_ser_rate = 17235;
    packet_in.rx_ser_rate = 17339;
    packet_in.tx_used_ser_bandwidth = 17;
    packet_in.rx_used_ser_bandwidth = 84;
    packet_in.txbuf = 151;

    mavlink::storm32::msg::MLRS_RADIO_LINK_FLOW_CONTROL packet1{};
    mavlink::storm32::msg::MLRS_RADIO_LINK_FLOW_CONTROL packet2{};
    ...
    EXPECT_EQ(packet1.tx_ser_rate, packet2.tx_ser_rate);
    EXPECT_EQ(packet1.rx_ser_rate, packet2.rx_ser_rate);
    EXPECT_EQ(packet1.tx_used_ser_bandwidth, packet2.tx_used_ser_bandwidth);
    EXPECT_EQ(packet1.rx_used_ser_bandwidth, packet2.rx_used_ser_bandwidth);
    EXPECT_EQ(packet1.txbuf, packet2.txbuf);
}

#ifdef TEST_INTEROP
TEST(storm32_interop, MLRS_RADIO_LINK_FLOW_CONTROL)
{
    mavlink_message_t msg;
    ...
    mavlink_mlrs_radio_link_flow_control_t packet_c {
         17235, 17339, 17, 84, 151
    };
    ...
    mavlink_msg_mlrs_radio_link_flow_control_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.tx_ser_rate, packet2.tx_ser_rate);
    EXPECT_EQ(packet_in.rx_ser_rate, packet2.rx_ser_rate);
    EXPECT_EQ(packet_in.tx_used_ser_bandwidth, packet2.tx_used_ser_bandwidth);
    EXPECT_EQ(packet_in.rx_used_ser_bandwidth, packet2.rx_used_ser_bandwidth);
