...
/** @brief  */
enum class MAV_AVSS_COMMAND_FAILURE_REASON
{
...
//! MAV_AVSS_COMMAND_FAILURE_REASON ENUM_END
constexpr auto MAV_AVSS_COMMAND_FAILURE_REASON_ENUM_END = 4;

/** @brief  */
enum class AVSS_M300_OPERATION_MODE
{
...
//! AVSS_M300_OPERATION_MODE ENUM_END
constexpr auto AVSS_M300_OPERATION_MODE_ENUM_END = 42;

/** @brief  */
enum class AVSS_HORSEFLY_OPERATION_MODE
{
...
//! AVSS_HORSEFLY_OPERATION_MODE ENUM_END
constexpr auto AVSS_HORSEFLY_OPERATION_MODE_ENUM_END = 5;
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_avss_prs_sys_status.hpp"
#include "./mavlink_msg_avss_drone_position.hpp"
#include "./mavlink_msg_avss_drone_imu.hpp"
#include "./mavlink_msg_avss_drone_operation_mode.hpp"
