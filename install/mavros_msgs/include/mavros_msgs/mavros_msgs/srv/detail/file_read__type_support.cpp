...
void fetch_function__FileRead_Response__data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint8_t *>(
    get_const_function__FileRead_Response__data(untyped_member, index));
  auto & value = *reinterpret_cast<uint8_t *>(untyped_value);
  value = item;
}

void assign_function__FileRead_Response__data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint8_t *>(
    get_function__FileRead_Response__data(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FileRead_Response_message_member_array[3] = {
  {
    ...
    fetch_function__FileRead_Response__data,  // fetch(index, &value) function pointer
    assign_function__FileRead_Response__data,  // assign(index, value) function pointer
