...
bool
mavros_msgs__msg__ESCTelemetry__are_equal(const mavros_msgs__msg__ESCTelemetry * lhs, const mavros_msgs__msg__ESCTelemetry * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // esc_telemetry
  if (!mavros_msgs__msg__ESCTelemetryItem__Sequence__are_equal(
...
bool
mavros_msgs__msg__ESCTelemetry__copy(
  const mavros_msgs__msg__ESCTelemetry * input,
  mavros_msgs__msg__ESCTelemetry * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // esc_telemetry
  if (!mavros_msgs__msg__ESCTelemetryItem__Sequence__copy(
      &(input->esc_telemetry), &(output->esc_telemetry)))
  {
    return false;
  }
  return true;
...
mavros_msgs__msg__ESCTelemetry__create()
{
  ...
  mavros_msgs__msg__ESCTelemetry * msg = (mavros_msgs__msg__ESCTelemetry *)allocator.allocate(sizeof(mavros_msgs__msg__ESCTelemetry), allocator.state);
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__msg__ESCTelemetry__Sequence__init(mavros_msgs__msg__ESCTelemetry__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__msg__ESCTelemetry *)allocator.zero_allocate(size, sizeof(mavros_msgs__msg__ESCTelemetry), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mavros_msgs__msg__ESCTelemetry__Sequence * array = (mavros_msgs__msg__ESCTelemetry__Sequence *)allocator.allocate(sizeof(mavros_msgs__msg__ESCTelemetry__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
mavros_msgs__msg__ESCTelemetry__Sequence__are_equal(const mavros_msgs__msg__ESCTelemetry__Sequence * lhs, const mavros_msgs__msg__ESCTelemetry__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mavros_msgs__msg__ESCTelemetry__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
mavros_msgs__msg__ESCTelemetry__Sequence__copy(
  const mavros_msgs__msg__ESCTelemetry__Sequence * input,
  mavros_msgs__msg__ESCTelemetry__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mavros_msgs__msg__ESCTelemetry);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mavros_msgs__msg__ESCTelemetry * data =
      (mavros_msgs__msg__ESCTelemetry *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mavros_msgs__msg__ESCTelemetry__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mavros_msgs__msg__ESCTelemetry__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mavros_msgs__msg__ESCTelemetry__copy(
