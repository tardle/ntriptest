...
bool
mavros_msgs__msg__MountControl__are_equal(const mavros_msgs__msg__MountControl * lhs, const mavros_msgs__msg__MountControl * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
mavros_msgs__msg__MountControl__copy(
  const mavros_msgs__msg__MountControl * input,
  mavros_msgs__msg__MountControl * output)
{
  if (!input || !output) {
    return false;
  }
...
mavros_msgs__msg__MountControl__create()
{
  ...
  mavros_msgs__msg__MountControl * msg = (mavros_msgs__msg__MountControl *)allocator.allocate(sizeof(mavros_msgs__msg__MountControl), allocator.state);
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__msg__MountControl__Sequence__init(mavros_msgs__msg__MountControl__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__msg__MountControl *)allocator.zero_allocate(size, sizeof(mavros_msgs__msg__MountControl), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mavros_msgs__msg__MountControl__Sequence * array = (mavros_msgs__msg__MountControl__Sequence *)allocator.allocate(sizeof(mavros_msgs__msg__MountControl__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
mavros_msgs__msg__MountControl__Sequence__are_equal(const mavros_msgs__msg__MountControl__Sequence * lhs, const mavros_msgs__msg__MountControl__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mavros_msgs__msg__MountControl__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
mavros_msgs__msg__MountControl__Sequence__copy(
  const mavros_msgs__msg__MountControl__Sequence * input,
  mavros_msgs__msg__MountControl__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mavros_msgs__msg__MountControl);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mavros_msgs__msg__MountControl * data =
      (mavros_msgs__msg__MountControl *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mavros_msgs__msg__MountControl__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mavros_msgs__msg__MountControl__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mavros_msgs__msg__MountControl__copy(
