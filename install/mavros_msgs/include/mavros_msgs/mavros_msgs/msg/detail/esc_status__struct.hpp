...
struct ESCStatus_
{
  ...
  using _esc_status_type =
    std::vector<mavros_msgs::msg::ESCStatusItem_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mavros_msgs::msg::ESCStatusItem_<ContainerAllocator>>>;
  ...
  Type & set__esc_status(
    const std::vector<mavros_msgs::msg::ESCStatusItem_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mavros_msgs::msg::ESCStatusItem_<ContainerAllocator>>> & _arg)
  {
