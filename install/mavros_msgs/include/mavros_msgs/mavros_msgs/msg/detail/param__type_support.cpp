...
{
  new (message_memory) mavros_msgs::msg::Param(_init);
}

void Param_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mavros_msgs::msg::Param *>(message_memory);
  typed_message->~Param();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Param_message_member_array[5] = {
  {
    "header",  // name
    ...
    offsetof(mavros_msgs::msg::Param, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mavros_msgs::msg::Param, param_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mavros_msgs::msg::Param, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mavros_msgs::msg::Param, param_index),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mavros_msgs::msg::Param, param_count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::mavros_msgs::msg::rosidl_typesupport_introspection_cpp::Param_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mavros_msgs, msg, Param)() {
  return &::mavros_msgs::msg::rosidl_typesupport_introspection_cpp::Param_message_type_support_handle;
}
