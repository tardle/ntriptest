...
#ifndef MAVROS_MSGS__MSG__DETAIL__ONBOARD_COMPUTER_STATUS__STRUCT_HPP_
#define MAVROS_MSGS__MSG__DETAIL__ONBOARD_COMPUTER_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__mavros_msgs__msg__OnboardComputerStatus __attribute__((deprecated))
#else
# define DEPRECATED__mavros_msgs__msg__OnboardComputerStatus __declspec(deprecated)
#endif
...
struct OnboardComputerStatus_
{
  ...
  // pointer types
  using RawPtr =
    mavros_msgs::msg::OnboardComputerStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const mavros_msgs::msg::OnboardComputerStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<mavros_msgs::msg::OnboardComputerStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<mavros_msgs::msg::OnboardComputerStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      mavros_msgs::msg::OnboardComputerStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<mavros_msgs::msg::OnboardComputerStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<mavros_msgs::msg::OnboardComputerStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<mavros_msgs::msg::OnboardComputerStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<mavros_msgs::msg::OnboardComputerStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__mavros_msgs__msg__OnboardComputerStatus
    std::shared_ptr<mavros_msgs::msg::OnboardComputerStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__mavros_msgs__msg__OnboardComputerStatus
    std::shared_ptr<mavros_msgs::msg::OnboardComputerStatus_<ContainerAllocator> const>
...
using OnboardComputerStatus =
  mavros_msgs::msg::OnboardComputerStatus_<std::allocator<void>>;
...
#endif  // MAVROS_MSGS__MSG__DETAIL__ONBOARD_COMPUTER_STATUS__STRUCT_HPP_
