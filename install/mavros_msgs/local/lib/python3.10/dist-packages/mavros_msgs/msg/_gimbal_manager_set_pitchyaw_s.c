...
bool mavros_msgs__msg__gimbal_manager_set_pitchyaw__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._gimbal_manager_set_pitchyaw.GimbalManagerSetPitchyaw", full_classname_dest, 69) == 0);
  }
  mavros_msgs__msg__GimbalManagerSetPitchyaw * ros_message = _ros_message;
  {  // target_system
...
{
  /* NOTE(esteve): Call constructor of GimbalManagerSetPitchyaw */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._gimbal_manager_set_pitchyaw");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GimbalManagerSetPitchyaw");
