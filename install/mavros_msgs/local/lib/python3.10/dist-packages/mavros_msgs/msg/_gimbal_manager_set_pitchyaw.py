...
class Metaclass_GimbalManagerSetPitchyaw(type):
    """Metaclass of message 'GimbalManagerSetPitchyaw'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__gimbal_manager_set_pitchyaw
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__gimbal_manager_set_pitchyaw
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__gimbal_manager_set_pitchyaw
            cls._TYPE_SUPPORT = module.type_support_msg__msg__gimbal_manager_set_pitchyaw
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__gimbal_manager_set_pitchyaw
    ...
    def GIMBAL_MANAGER_FLAGS_RETRACT(self):
        ...
        return Metaclass_GimbalManagerSetPitchyaw.__constants['GIMBAL_MANAGER_FLAGS_RETRACT']

    @property
    def GIMBAL_MANAGER_FLAGS_NEUTRAL(self):
        """Message constant 'GIMBAL_MANAGER_FLAGS_NEUTRAL'."""
        return Metaclass_GimbalManagerSetPitchyaw.__constants['GIMBAL_MANAGER_FLAGS_NEUTRAL']

    @property
    def GIMBAL_MANAGER_FLAGS_ROLL_LOCK(self):
        """Message constant 'GIMBAL_MANAGER_FLAGS_ROLL_LOCK'."""
        return Metaclass_GimbalManagerSetPitchyaw.__constants['GIMBAL_MANAGER_FLAGS_ROLL_LOCK']

    @property
    def GIMBAL_MANAGER_FLAGS_PITCH_LOCK(self):
        """Message constant 'GIMBAL_MANAGER_FLAGS_PITCH_LOCK'."""
        return Metaclass_GimbalManagerSetPitchyaw.__constants['GIMBAL_MANAGER_FLAGS_PITCH_LOCK']

    @property
    def GIMBAL_MANAGER_FLAGS_YAW_LOCK(self):
        """Message constant 'GIMBAL_MANAGER_FLAGS_YAW_LOCK'."""
        return Metaclass_GimbalManagerSetPitchyaw.__constants['GIMBAL_MANAGER_FLAGS_YAW_LOCK']


class GimbalManagerSetPitchyaw(metaclass=Metaclass_GimbalManagerSetPitchyaw):
    """
    Message class 'GimbalManagerSetPitchyaw'.
