...
bool mavros_msgs__msg__gimbal_device_attitude_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.msg._gimbal_device_attitude_status.GimbalDeviceAttitudeStatus", full_classname_dest, 73) == 0);
  }
  mavros_msgs__msg__GimbalDeviceAttitudeStatus * ros_message = _ros_message;
  {  // header
...
PyObject * mavros_msgs__msg__gimbal_device_attitude_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.msg._gimbal_device_attitude_status");
