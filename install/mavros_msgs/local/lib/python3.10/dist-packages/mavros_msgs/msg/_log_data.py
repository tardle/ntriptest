...
class Metaclass_LogData(type):
    """Metaclass of message 'LogData'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'mavros_msgs.msg.LogData')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__log_data
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__log_data
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__log_data
            cls._TYPE_SUPPORT = module.type_support_msg__msg__log_data
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__log_data
...
class LogData(metaclass=Metaclass_LogData):
    """Message class 'LogData'."""
