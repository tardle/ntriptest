...
bool mavros_msgs__srv__gimbal_manager_set_roi__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.srv._gimbal_manager_set_roi.GimbalManagerSetRoi_Request", full_classname_dest, 67) == 0);
  }
  mavros_msgs__srv__GimbalManagerSetRoi_Request * ros_message = _ros_message;
  {  // mode
...
{
  /* NOTE(esteve): Call constructor of GimbalManagerSetRoi_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.srv._gimbal_manager_set_roi");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GimbalManagerSetRoi_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool mavros_msgs__srv__gimbal_manager_set_roi__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mavros_msgs.srv._gimbal_manager_set_roi.GimbalManagerSetRoi_Response", full_classname_dest, 68) == 0);
  }
  mavros_msgs__srv__GimbalManagerSetRoi_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of GimbalManagerSetRoi_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mavros_msgs.srv._gimbal_manager_set_roi");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GimbalManagerSetRoi_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
